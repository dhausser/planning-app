module.exports = {
  Query: {
    ...
    issue: (_, { id }, { dataSources }) => dataSources.issueAPI.getIssueById(id),
    projects: (_, __, { dataSources }) => dataSources.issueAPI.getProjects(),
    versions: (_, { id }, { dataSources }) => dataSources.issueAPI.getVersions(id),
    statuses: (_, { id }, { dataSources }) => dataSources.issueAPI.getStatuses(id),
    ...
    resources(_, __, { dataSources }) { return dataSources.userAPI.findUsers(); },
    resource(_, { id }, { dataSources }) { return dataSources.userAPI.findUser({ id }); },
    ...
    team: (_, { id }, { dataSources }) => dataSources.resourceAPI.getResources({ teamId: id }),
  },
